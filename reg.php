...
.bg{
	background-image:url("crowd5.jpg");
...
<body>
<div class="bg w3-container"> 
  <body>
<div class="container">
	<section id="content">
		<form action="" method="post">
			<h1>Registeration Form</h1>
			<label style="color:white;" for="email"><b>Username or Email</b></label>
    ...
    <label style="color:white;" for="psw-repeat"><b>Confirm Password</b></label>
    <input type="password" placeholder="Confirm Password" name="passwordAgain" required>
    ...
    <div class="yoButtons">
      <button type="reset" name="cancelbtn">Clear</button>
      
      <button type="submit"  name="register_btn" color="white">Sign Up</button>
	  <a href="log.php">Already signed up?</a>
    </div>
		</form><!-- form -->
